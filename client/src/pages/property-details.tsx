        ...
        <Box flex={1} maxWidth={764}>
          ...
          <Box mt='15px'>
            <Stack direction='row' justifyContent='space-between' flexWrap='wrap' alignItems='center'>
              <Typography
                fontSize={18} fontWeight={500} color='#11142d' textTransform='capitalize'
              >{propertyDetails.propertyType}</Typography>
              <Box>
                {[1, 2, 3, 4, 5].map((item) => (
                  <Star
                    key={`star-${item}`}
            ...
            <Stack direction='row' justifyContent='space-between' flexWrap='wrap' alignItems='center'>
              <Box> 
                <Typography
                  fontSize={22} fontWeight={600} color='#11142d' textTransform='capitalize'
                >{propertyDetails.title}</Typography>
          ...
          >
            ...
            >
              ...
              >
                ...
                {propertyDetails.creator.allProperties.length < 2 ? 'Property' : 'Properties'}
              </Typography>
          </Stack>
